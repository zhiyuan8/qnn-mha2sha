...
class OpFactory:
    ...
    def get_div_op_nodes(self, input_node_1: NodeProto, input_node_2: NodeProto, propose_op_name: str = "Div") -> NodeProto:
        """Creates an ONNX Div operation Node for dividing two nodes.
        
        Args:
            input_node_1: First input node (numerator)
            input_node_2: Second input node (denominator)  
            propose_op_name: The proposed name of the Div node, default is "Div"
